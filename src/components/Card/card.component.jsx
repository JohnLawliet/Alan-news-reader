...
const NewsCard = ({ article: {description, title, publishedAt, url, urlToImage, source}, index, activeArticle }) => {
    ...
    return (
        <Card ref={elRefs[index]} className={ activeArticle === index ? classes.activeCard : classes.card}>
